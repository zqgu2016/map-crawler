...
const output = './mapbox-vector';
// 图层
const zooms = [13, 14, 15, 16, 17, 18, 19, 20];
processLatlng(31.383233694021424, 120.50617461775104, 31.263729, 120.681555, zooms, output);
...
function download(x, y, z, img) {
  return new Promise((resolve, reject) => {
    ...
    request
      .get(
        `https://api.tiles.mapbox.com/v4/mapbox.streets/${z}/${x}/${y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw`
      )
      .pipe(writeStream);
  });
}
